 ...
 *
 * Pure — no Three, no React. The `SurfaceCanvas` adapter calls these from
 * `useFrame` and applies the result to the camera reference. That keeps the
 * core math testable without spinning up an R3F context in jest+jsdom.
 *
