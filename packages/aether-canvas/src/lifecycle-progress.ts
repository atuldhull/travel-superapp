/**
 * Lifecycle phase progress — pure helpers.
 *
 ...
 *
 * This file is pure (no React, no Three). The `SurfaceCanvas` adapter feeds
 * `useFrame` deltas into these functions and renders the result.
 *
