...
export const getFoodControllerDishesInfiniteQueryKey = (eateryId?: string) => {
  return ['infinite', `/api/v1/eateries/${eateryId}/dishes`] as const;
};

export const getFoodControllerDishesQueryKey = (eateryId?: string) => {
  return [`/api/v1/eateries/${eateryId}/dishes`] as const;
};

export const getFoodControllerDishesInfiniteQueryOptions = <
  TData = Awaited<ReturnType<typeof foodControllerDishes>>,
  TError = unknown,
>(
  eateryId: string,
  options?: {
    query?: UseInfiniteQueryOptions<
      Awaited<ReturnType<typeof foodControllerDishes>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof apiFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof foodControllerDishes>>> = ({ signal }) =>
    foodControllerDishes(eateryId, { signal, ...requestOptions });
  ...
  return {
    ...
    staleTime: 30000,
    ...queryOptions,
  } as UseInfiniteQueryOptions<Awaited<ReturnType<typeof foodControllerDishes>>, TError, TData> & {
    queryKey: QueryKey;
  };
};

export type FoodControllerDishesInfiniteQueryResult = NonNullable<
  Awaited<ReturnType<typeof foodControllerDishes>>
>;
...
export function useFoodControllerDishesInfinite<
  TData = Awaited<ReturnType<typeof foodControllerDishes>>,
  TError = unknown,
>(
  eateryId: string,
...
export const getFoodControllerDishesQueryOptions = <
  TData = Awaited<ReturnType<typeof foodControllerDishes>>,
  TError = unknown,
>(
  eateryId: string,
  options?: {
    query?: UseQueryOptions<Awaited<ReturnType<typeof foodControllerDishes>>, TError, TData>;
    request?: SecondParameter<typeof apiFetch>;
  },
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};
  ...
  return {
    ...
    staleTime: 30000,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof foodControllerDishes>>, TError, TData> & {
    queryKey: QueryKey;
  };
};

export type FoodControllerDishesQueryResult = NonNullable<
  Awaited<ReturnType<typeof foodControllerDishes>>
>;
...
export function useFoodControllerDishes<
  TData = Awaited<ReturnType<typeof foodControllerDishes>>,
  TError = unknown,
>(
  eateryId: string,
...
export const getFoodControllerCreateDishMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type FoodControllerCreateDishMutationResult = NonNullable<
  Awaited<ReturnType<typeof foodControllerCreateDish>>
>;
 ...
 * @summary Report a dish on an eatery (auth required).
 */
export const useFoodControllerCreateDish = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof foodControllerCreateDish>>,
    TError,
    { eateryId: string; data: AddDishReportRequestDto },
...
export const getFoodCrawlControllerBuildMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type FoodCrawlControllerBuildMutationResult = NonNullable<
  Awaited<ReturnType<typeof foodCrawlControllerBuild>>
>;
 ...
 * @summary Build a walking-optimised food crawl across 2..5 eateries. Owner-gated against the trip.
 */
export const useFoodCrawlControllerBuild = <TError = unknown, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof foodCrawlControllerBuild>>,
    TError,
    { tripId: string; data: BuildFoodCrawlRequestDto },
