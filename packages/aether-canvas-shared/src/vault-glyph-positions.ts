/**
 * Vault floating-glyph ring math — pure helpers (AE456).
 *
 * Moved from `apps/web/src/components/aether/phase2/vault-glyph-positions.ts`
 * into the Phase 4 shared sub-package so both web R3F and native R3F
 * render the price-ring with identical sphere geometry.
 *
