/**
 * Atlas Phase 1 — pure orb layout math (AE456).
 *
 * Moved from `apps/web/src/components/aether/phase1/atlas-orbs.ts` into
 * the Phase 4 shared sub-package so both web R3F and native R3F render
 * the trip-studio orb cloud with identical world coordinates.
 *
