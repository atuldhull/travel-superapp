/**
 * Public API of the Feed module. Cross-module CODE consumers
 ...
 *
 * The ONE exception is the NestJS module class `FeedModule` —
 * cross-module DI imports use `./feed.module` directly, not this
