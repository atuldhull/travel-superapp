/**
 * Public API of the Translation module. Cross-module CODE consumers
 ...
 *
 * The ONE exception is the NestJS module class `TranslationModule` —
 * cross-module DI imports use `./translation.module` directly, not this
...
export * from './application/ports/translator.port';
