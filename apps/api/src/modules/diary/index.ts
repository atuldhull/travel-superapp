/**
 * Public API of the Diary module. Cross-module CODE consumers
 ...
 *
 * The ONE exception is the NestJS module class `DiaryModule` —
 * cross-module DI imports use `./diary.module` directly, not this
...
export * from './application/ports/diary-ai-assistant.port';
export * from './application/ports/diary.repository';
export * from './application/ports/gamification.repository';
