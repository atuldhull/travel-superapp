/**
 * AE398 — pure helpers for the Lumen photo cloud layout.
 *
 ...
 * AE398 ships the pure layout math; AE399 wires the R3F scene + shell;
 * AE400 attaches real photos via `useMediaControllerListByTrip`.
 *
