 ...
 *
 * Pure data + a slug-aware lookup. Used by the real-weather hook to
 * call Open-Meteo with the right coordinates. The slug aliases match
 * AE384 `destination-palettes.ts` so a "Five days in Ladakh" trip
 * still resolves to Leh's coords.
 *
