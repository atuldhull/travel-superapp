/**
 * Pure helpers for the AE389 Pulse Phase 1 breathing math.
 *
 ...
 *
 * Everything here is pure (no React, no R3F, no time source) so the
 * lifecycle scene can drive it from `useFrame`'s delta clock + tests
